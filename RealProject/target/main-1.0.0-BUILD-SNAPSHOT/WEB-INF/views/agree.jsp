...
<html>
	<head>
		...
		<style>
		body{background-image: url('resources/img/back.jpg')}
		</style>
	</head>
	<body style="overflow-x:hidden; overflow-y:auto;">
		<form action="joinForm" name="form" method="post">
 <table width="1400" height="650">
  <tr>
   <td width="100%" height="10%"><span style="padding-left: 160px">
   <a href="./"><img
    src="resources/img/mainwhite.jpg" width="290" height="100" border="0"
    align="middle"/></a>
    </span>&nbsp;
    <br>
    <hr>
  ...
  <tr>
   ...
   <p align="left">
   <br>
   <span style="padding-left: 160px; color:black">
   IC FIVE 약관동의</span>
   ...
   <textarea rows="20" cols="150">
   		제 1 조 (목적)
이 약관은 IC FIVE가 제공하는 e알리미의 이용과 관련하여 회사와 소속기관, 그리고 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
제 24 조 (서비스 이용 불만 처리)
1. 서비스 이용과 관련한 불만사항은 e알리미 서비스 내 고객문의에 등록 또는 victorehko12@naver.com로 메일을 보내주시면 접수하여 처리합니다.
...
부칙
본 약관은 2017년 08월 7일부터 적용됩니다.
   </textarea>
   <br>
   <input type="checkbox" name="req"> 회원약관 이용에 동의합니다. 
   <br>
   </td>
  </tr>
  <tr>
   <td align="center" valign="top">
	...
	<script>
	function chk(){
		 var req = document.form.req.length;
		 var num = 0;
		 
		 for(var idx = 0; idx<req; idx++){
			 if (eval("document.form.req[" + idx + "].checked") == true) {
					num += 1;
			   }
		 }
		 if(num==2){
		  ...
		  alert("개인정보 약관 및 회원약관에 모두 동의하셔야 합니다.");
		 }
		}
		function nochk(){
